...
public class ReportFrame extends javax.swing.JFrame {
   ...
   private void performSearch() {
    ...
    try {
        // Using UPPER() for explicit case-insensitive search
        String sql = "SELECT id FROM inmates WHERE (UPPER(first_name) LIKE UPPER(?) OR UPPER(last_name) LIKE UPPER(?) OR UPPER(code) LIKE UPPER(?)) AND status = 'active'";
        PreparedStatement pstmt = connection.prepareStatement(sql);
   ...
   private void onDateFilterChanged() {
    ...
    private void initComponents() {
        ...
        totalTimeServedWidget.setText("jLabel2");
        ...
        jPanel3.add(statusBadge, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 110, 90, 40));
